...
import loginback from '../images/lmsbg.jpg';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url(${loginback})` }}>
      <div className="w-full max-w-lg bg-white bg-opacity-15 backdrop-blur-lg rounded-3xl shadow-2xl p-8 flex flex-col items-center border border-sky-400 border-opacity-50 mx-4 dark:bg-black dark:bg-opacity-25">
        {/* Language Dropdown */}
        <div className="w-full flex justify-end mb-4">
          <select
            value={language}
            onChange={e => setLanguage(e.target.value)}
            className="p-2 rounded-lg border border-sky-400 bg-white text-black font-semibold shadow-md"
          >
        ...
        {!isForgotPassword ? (
            ...
            {isLogin ? (
              ...
              >
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    className="p-3 text-base border border-sky-400 rounded-lg focus:outline-none focus:border-sky-600 focus:ring-2 focus:ring-sky-600 focus:ring-opacity-50 bg-white text-black shadow-md transition-all duration-300"
                    type="email"
                    name="email"
                ...
                <p
                  className="text-right text-white cursor-pointer text-sm font-bold hover:text-sky-300 transition-colors duration-300"
                  onClick={() => {
                    setError("");
                ...
                <button
                  type="submit"
                  className="bg-sky-600 text-white font-bold border-none p-3 rounded-lg mt-2 transition-all duration-300 hover:bg-sky-700 hover:shadow-lg transform hover:scale-105"
                >
                  {t.loginBtn}
                </button>
                <p className="text-white mt-3 text-center font-semibold">
                  ...
                  <span
                    className="cursor-pointer text-sky-300 hover:text-sky-200 transition-colors duration-300 underline"
                    onClick={() => {
                      setError("");
                      setIsLogin(false);
                    }}
          ...
          <>
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-sky-300 text-center">
              {t.resetTitle}
            </h2>
            <form
            ...
            >
              ...
              <p className="text-sky-300 mt-3 text-center font-semibold">
                <span
