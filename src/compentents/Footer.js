...
const translations = {
  en: {
    ...
    smartSearch: "Data Science",
    contentGen: "UI Design",
    dataAnalytics: "Mobie Development",
    designIntelligence: "Business&Marketing",
    securitySolutions: "Cyber Security",
    ...
    <footer className="bg-white text-black dark:bg-black py-12 px-5 md:px-8 font-sans">
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-8 md:gap-10 footer-grid">
        ...
        <div className="flex-1 min-w-[200px] px-5">
          ...
          <ul className="list-none p-0 m-0">
            <li className="mb-2"><Link to="/webdevelopment" className="text-black dark:text-gray-400 hover:text-sky-800 dark:hover:text-sky-300 transition-colors no-underline">{t.chatbots}</Link></li>
            <li className="mb-2"><Link to="/datascience" className="text-black dark:text-gray-400 hover:text-sky-800 dark:hover:text-sky-300 transition-colors no-underline">{t.smartSearch}</Link></li>
            <li className="mb-2"><Link to="/uidesign" className="text-black dark:text-gray-400 hover:text-sky-800 dark:hover:text-sky-300 transition-colors no-underline">{t.contentGen}</Link></li>
            <li className="mb-2"><Link to="/mobiledevelopment" className="text-black dark:text-gray-400 hover:text-sky-800 dark:hover:text-sky-300 transition-colors no-underline">{t.dataAnalytics}</Link></li>
            <li className="mb-2"><Link to="/business-marketing" className="text-black dark:text-gray-400 hover:text-sky-800 dark:hover:text-sky-300 transition-colors no-underline">{t.designIntelligence}</Link></li>
            <li className="mb-2"><Link to="/cybersecurity" className="text-black dark:text-gray-400 hover:text-sky-800 dark:hover:text-sky-300 transition-colors no-underline">{t.securitySolutions}</Link></li>
          </ul>
        </div>
        {/* Social & Contact */}
        <div className="flex-1 min-w-[200px] px-5">
