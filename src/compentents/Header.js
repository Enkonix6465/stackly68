    ...
    <header className="fixed top-0 left-0 w-full bg-white dark:bg-black text-black dark:text-gray-100 flex justify-between items-center px-6 py-4 border-b border-gray-300 dark:border-gray-700 z-50 h-20">
      ...
      >
        ...
        <div className="relative">
          <span
            className={`cursor-pointer font-medium ${
              activeLink === "home" ? "text-sky-400 dark:text-sky-400" : ""
            }`}
            ...
            <div className="absolute left-0 mt-2 flex flex-col bg-gray-100 dark:bg-gray-800 rounded shadow-md min-w-[160px] z-50">
              <Link
                ...
                className={`px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 ${
                  location.pathname === "/home1" ? "text-sky-400 dark:text-sky-400 font-bold" : ""
                }`}
              >
                Home1
              </Link>
              <Link
                ...
                onClick={handleLinkClick}
                className={`px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 ${
                  location.pathname === "/home2" ? "text-sky-400 dark:text-sky-400 font-bold" : ""
                }`}
              >
                Home 2
              </Link>
        ...
        <Link
          ...
          className={`font-medium ${
            activeLink === "about" ? "text-sky-400 dark:text-sky-400" : ""
          }`}
        >
        ...
        <div className="relative">
          <span
            className={`cursor-pointer font-medium ${
              activeLink === "services" ? "text-sky-700 dark:text-sky-400" : ""
            }`}
          ...
          {activeDropdown === "services" && (
            <div className="absolute left-0 mt-2 flex flex-col bg-gray-100 dark:bg-gray-800 rounded shadow-md min-w-[200px] z-50">
              {[
                ...
                { to: "/uidesign", label: "UI Design" },
                { to: "/mobiledevelopment", label: "Mobile Development" },
                { to: "/business-marketing", label: "Business & Marketing" },
                ...
                <Link
                  ...
                  onClick={handleLinkClick}
                  className={`px-4 py-2 hover:bg-gray-200 dark:hover:bg-gray-700 ${
                    location.pathname === item.to ? "text-sky-400 dark:text-sky-400 font-bold" : ""
                  }`}
                >
                  {item.label}
                </Link>
        ...
        <Link
          ...
          onClick={handleLinkClick}
          className={`font-medium ${
            activeLink === "blog" ? "text-sky-400 dark:text-text-400" : ""
          }`}
        >
        ...
        <Link
          ...
          onClick={handleLinkClick}
          className={`font-medium ${
            activeLink === "contact" ? "text-sky-400 dark:text-sky-400" : ""
          }`}
        >
      ...
      <div className="flex items-center gap-2">
        ...
        <div ref={avatarRef} className="relative">
          <div
            className="w-10 h-10 bg-sky-600 text-white flex items-center justify-center rounded-full font-bold cursor-pointer"
